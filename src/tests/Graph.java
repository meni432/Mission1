 ...
 * Bag.java Stack.java In.java StdOut.java Data files:
...
public class Graph {
    ...
    private PairSet pairSet = new PairSet();
     ...
     * @throws IndexOutOfBoundsException unless both {@code 0 <= v < V} and
     * {@code 0 <= w < V}
     */
...
//        return s.toString();
    ...
    public String fileOutput() {
        ...
        return V + NEWLINE + numberOfEdges + NEWLINE + s.toString();
    }
